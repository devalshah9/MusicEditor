...
//    String result = renderNotes(notes);
//  }
//
//  /**
...
//   */
//  private String renderNotes(TreeMap<Integer, ArrayList<Note>> notes) {
...
//    }
//
//    int beginIndex = newNotes.indexOf(sheet.getLowestNote());
//    int endIndex = newNotes.indexOf(sheet.getHighestNote());
//    List<Note> newNotes = newNotes.subList(beginIndex, endIndex + 1);
//    int columnLength = 5;
//    result = result + "\n";
